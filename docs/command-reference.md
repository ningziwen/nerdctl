...
- :nerd_face: `--verify`: Verify the image (none|cosign|notation). See [`docs/cosign.md`](./cosign.md) and [`docs/notation.md`](./notation.md) for details.
...
- :nerd_face: `--sign`: Sign the image (none|cosign|notation). See [`docs/cosign.md`](./cosign.md) and [`docs/notation.md`](./notation.md) for details.
